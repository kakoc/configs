...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(avy-background-face ((((class color) (min-colors 89)) (:foreground "#373b41"))) t)
 '(font-lock-function-name-face ((t (:foreground "#7CA1EB"))))
 '(font-lock-type-face ((t (:foreground "#F2C16F"))))
 ...
 '(twittering-username-face ((((class color) (min-colors 89)) (:inherit erc-pal-face))) t)
 '(typescript-access-modifier-face ((t (:inherit font-lock-keyword-face :foreground "#BB8DD2"))))
 '(typescript-this-face ((t (:inherit font-lock-keyword-face :foreground "#FA5571"))))
